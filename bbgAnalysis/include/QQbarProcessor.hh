...
namespace QQbarProcessor 
{
  ...
  public:
    ...
    int NMC;
    int mc_hadron_n;
    double mc_hadron_px[300];
    double mc_hadron_py[300];
    double mc_hadron_pz[300];
    int mc_hadron_pdg[300];
    double mc_hadron_E[300];
    float mc_hadron_charge[300];
    double mc_hadron_mass[300];*/
