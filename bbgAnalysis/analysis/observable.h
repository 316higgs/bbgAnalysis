...
public :
  ...
  TString process="bbbar";
   ...
   Float_t         mc_hadron_E[300];
   Float_t         mc_hadron_px[300];
   Float_t         mc_hadron_py[300];
   Float_t         mc_hadron_pz[300];
   Float_t         mc_hadron_m[300];
   Float_t         mc_hadron_pdg[300];
   Float_t         mc_hadron_charge[300];
   Int_t           mc_hadron_n;
